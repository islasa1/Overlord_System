...
#ifndef DRIVERS_HW_MPU9250_H_
#define DRIVERS_HW_MPU9250_H_
...
//
//*****************************************************************************
#define MPU9250_O_SELF_TEST_X   0x0D        // Self test X register
#define MPU9250_O_SELF_TEST_Y   0x0E        // Self test Y register
#define MPU9250_O_SELF_TEST_Z   0x0F        // Self test Z register
#define MPU9250_O_SELF_TEST_A   0x10        // Self test A register
...
#define MPU9250_O_ACCEL_CONFIG  0x1C        // Accelerometer configuration
                                            // register
#define MPU9250_O_FF_THR        0x1D        // Free-fall threshold register
#define MPU9250_O_FF_DUR        0x1E        // Free-fall duration register
#define MPU9250_O_MOT_THR       0x1F        // Motion detection threshold
                                            // register
#define MPU9250_O_MOT_DUR       0x20        // Motion detection duration
                                            // register
#define MPU9250_O_ZRMOT_THR     0x21        // Zero motion detection threshold
                                            // register
#define MPU9250_O_ZRMOT_DUR     0x22        // Zero motion detection duration
                                            // register
...
#define MPU9250_O_I2C_SLV0_REG  0x26        // I2C slave 0 register number
                                            // register
...
#define MPU9250_O_I2C_SLV1_REG  0x29        // I2C slave 1 register number
                                            // register
...
#define MPU9250_O_I2C_SLV2_REG  0x2C        // I2C slave 2 register number
                                            // register
...
#define MPU9250_O_I2C_SLV3_REG  0x2F        // I2C slave 3 register number
                                            // register
...
#define MPU9250_O_I2C_SLV4_REG  0x32        // I2C slave 4 register number
                                            // register
...
#define MPU9250_O_I2C_MST_STATUS                                              \
...
#define MPU9250_O_ACCEL_XOUT_H  0x3B        // X-axis acceleration data MSB
                                            // register
#define MPU9250_O_ACCEL_XOUT_L  0x3C        // X-axis acceleration data LSB
                                            // register
#define MPU9250_O_ACCEL_YOUT_H  0x3D        // Y-axis acceleration data MSB
                                            // register
#define MPU9250_O_ACCEL_YOUT_L  0x3E        // Y-axis accelearation data LSB
                                            // register
#define MPU9250_O_ACCEL_ZOUT_H  0x3F        // Z-axis acceleration data MSB
                                            // register
#define MPU9250_O_ACCEL_ZOUT_L  0x40        // Z-axis acceleration data LSB
                                            // register
...
#define MPU9250_O_I2C_MST_DELAY_CTRL                                          \
                                0x67        // I2C master delay control
                                            // register
#define MPU9250_O_SIGNAL_PATH_RESET                                           \
                                0x68        // Signal path reset register
#define MPU9250_O_MOT_DETECT_CTRL                                             \
...
//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_SELF_TEST_X
// register.
//
//*****************************************************************************
#define MPU9250_SELF_TEST_X_XA_TEST_M                                         \
                                0xE0        // Accelerometer XA_TEST[4:2]
#define MPU9250_SELF_TEST_X_XG_TEST_M                                         \
                                0x1F        // Gyro XG_TEST[4:0]
#define MPU9250_SELF_TEST_X_XA_TEST_S                                         \
                                5
#define MPU9250_SELF_TEST_X_XG_TEST_S                                         \
                                0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_SELF_TEST_Y
// register.
//
//*****************************************************************************
#define MPU9250_SELF_TEST_Y_YA_TEST_M                                         \
                                0xE0        // Accelerometer YA_TEST[4:2]
#define MPU9250_SELF_TEST_Y_YG_TEST_M                                         \
                                0x1F        // Gyro YG_TEST[4:0]
#define MPU9250_SELF_TEST_Y_YA_TEST_S                                         \
                                5
#define MPU9250_SELF_TEST_Y_YG_TEST_S                                         \
                                0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_SELF_TEST_Z
// register.
//
//*****************************************************************************
#define MPU9250_SELF_TEST_Z_ZA_TEST_M                                         \
                                0xE0        // Accelerometer ZA_TEST[4:2]
#define MPU9250_SELF_TEST_Z_ZG_TEST_M                                         \
                                0x1F        // Gyro ZG_TEST[4:0]
#define MPU9250_SELF_TEST_Z_ZA_TEST_S                                         \
                                5
#define MPU9250_SELF_TEST_Z_ZG_TEST_S                                         \
                                0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_SELF_TEST_A
// register.
//
//*****************************************************************************
#define MPU9250_SELF_TEST_A_XA_TEST_M                                         \
                                0x30        // Accelerometer XA_TEST[1:0]
#define MPU9250_SELF_TEST_A_YA_TEST_M                                         \
                                0x0C        // Accelerometer YA_TEST[1:0]
#define MPU9250_SELF_TEST_A_ZA_TEST_M                                         \
                                0x03        // Accelerometer ZA_TEST[1:0]
#define MPU9250_SELF_TEST_A_XA_TEST_S                                         \
                                4
#define MPU9250_SELF_TEST_A_YA_TEST_S                                         \
                                2
#define MPU9250_SELF_TEST_A_ZA_TEST_S                                         \
                                0
...
#define MPU9250_ACCEL_CONFIG_AFS_SEL_16G                                      \
                                0x18        // Accelerometer full-scale range
                                            // 16 g
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_M                                      \
                                0x07        // High-pass filter setting
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_RESET                                  \
                                0x00        // High-pass filter reset
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_5HZ                                    \
                                0x01        // High-pass filter at 5 Hz
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_2_5HZ                                  \
                                0x02        // High-pass filter at 2.5 Hz
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_1_25HZ                                 \
                                0x03        // High-pass filter at 1.25 Hz
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_0_63HZ                                 \
                                0x04        // High-pass filter at 0.63 Hz
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_HOLD                                   \
                                0x07        // High-pass filter hold
#define MPU9250_ACCEL_CONFIG_AFS_SEL_S                                        \
                                3
#define MPU9250_ACCEL_CONFIG_ACCEL_HPF_S                                      \
                                0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_FF_THR
// register.
//
//*****************************************************************************
#define MPU9250_FF_THR_M        0xFF        // Free-fall threshold value
#define MPU9250_FF_THR_S        0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_FF_DUR
// register.
//
//*****************************************************************************
#define MPU9250_FF_DUR_M        0xFF        // Free-fall duration value
#define MPU9250_FF_DUR_S        0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_MOT_THR
// register.
//
//*****************************************************************************
#define MPU9250_MOT_THR_M       0xFF        // Motion detection threshold value
#define MPU9250_MOT_THR_S       0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_MOT_DUR
// register.
//
//*****************************************************************************
#define MPU9250_MOT_DUR_M       0xFF        // Motion detection duration value
#define MPU9250_MOT_DUR_S       0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_ZRMOT_THR
// register.
//
//*****************************************************************************
#define MPU9250_ZRMOT_THR_M     0xFF        // Zero motion detection threshold
                                            // value
#define MPU9250_ZRMOT_THR_S     0

//*****************************************************************************
//
// The following are defines for the bit fields in the MPU9250_O_ZRMOT_DUR
// register.
//
//*****************************************************************************
#define MPU9250_ZRMOT_DUR_M     0xFF        // Zero motion detection duration
                                            // value
#define MPU9250_ZRMOT_DUR_S     0
...
//
//*****************************************************************************
#define MPU9250_FIFO_EN_TEMP    0x80        // Temperature sensor FIFO enable
#define MPU9250_FIFO_EN_XG      0x40        // X-axis gyro FIFO enable
#define MPU9250_FIFO_EN_YG      0x20        // Y-axis gyro FIFO enable
#define MPU9250_FIFO_EN_ZG      0x10        // Z-axis gyro FIFO enable
...
//
//*****************************************************************************
#define MPU9250_I2C_SLV1_ADDR_RW                                              \
                                0x80        // Read/not write
...
//
//*****************************************************************************
#define MPU9250_I2C_SLV1_CTRL_EN                                              \
                                0x80        // Enable slave
#define MPU9250_I2C_SLV1_CTRL_BYTE_SW                                         \
                                0x40        // Byte-swap word pairs
#define MPU9250_I2C_SLV1_CTRL_REG_DIS                                         \
                                0x20        // Disable register number transfer
#define MPU9250_I2C_SLV1_CTRL_GRP                                             \
                                0x10        // Word pair grouping
#define MPU9250_I2C_SLV1_CTRL_LEN_M                                           \
                                0x0F        // Number of bytes to transfer
#define MPU9250_I2C_SLV1_CTRL_LEN_S                                           \
                                0
...
//
//*****************************************************************************
#define MPU9250_I2C_SLV2_ADDR_RW                                              \
                                0x80        // Read/not write
...
//
//*****************************************************************************
#define MPU9250_I2C_SLV2_CTRL_EN                                              \
                                0x80        // Enable slave
#define MPU9250_I2C_SLV2_CTRL_BYTE_SW                                         \
                                0x40        // Byte-swap word pairs
#define MPU9250_I2C_SLV2_CTRL_REG_DIS                                         \
                                0x20        // Disable register number transfer
#define MPU9250_I2C_SLV2_CTRL_GRP                                             \
                                0x10        // Word pair grouping
#define MPU9250_I2C_SLV2_CTRL_LEN_M                                           \
                                0x0F        // Number of bytes to transfer
#define MPU9250_I2C_SLV2_CTRL_LEN_S                                           \
                                0
...
//
//*****************************************************************************
#define MPU9250_I2C_SLV3_ADDR_RW                                              \
                                0x80        // Read/not write
...
//
//*****************************************************************************
#define MPU9250_I2C_SLV3_CTRL_EN                                              \
                                0x80        // Enable slave
#define MPU9250_I2C_SLV3_CTRL_BYTE_SW                                         \
                                0x40        // Byte-swap word pairs
#define MPU9250_I2C_SLV3_CTRL_REG_DIS                                         \
                                0x20        // Disable register number transfer
#define MPU9250_I2C_SLV3_CTRL_GRP                                             \
                                0x10        // Word pair grouping
#define MPU9250_I2C_SLV3_CTRL_LEN_M                                           \
                                0x0F        // Number of bytes to transfer
#define MPU9250_I2C_SLV3_CTRL_LEN_S                                           \
                                0
...
//
//*****************************************************************************
#define MPU9250_I2C_SLV4_ADDR_RW                                              \
                                0x80        // Read/not write
...
//
//*****************************************************************************
#define MPU9250_I2C_MST_STATUS_PASS_THROUGH                                   \
                                0x80        // Pass through FSYNC interrupt
                                            // status
#define MPU9250_I2C_MST_STATUS_I2C_SLV4_DONE                                  \
                                0x40        // I2C slave 4 completion status
#define MPU9250_I2C_MST_STATUS_I2C_LOST_ARB                                   \
                                0x20        // I2C arbitration lost status
#define MPU9250_I2C_MST_STATUS_I2C_SLV4_NACK                                  \
                                0x10        // I2C slave 4 NACK status
#define MPU9250_I2C_MST_STATUS_I2C_SLV3_NACK                                  \
                                0x08        // I2C slave 3 NACK status
#define MPU9250_I2C_MST_STATUS_I2C_SLV2_NACK                                  \
                                0x04        // I2C slave 2 NACK status
#define MPU9250_I2C_MST_STATUS_I2C_SLV1_NACK                                  \
                                0x02        // I2C slave 1 NACK status
#define MPU9250_I2C_MST_STATUS_I2C_SLV0_NACK                                  \
...
//
//*****************************************************************************
#define MPU9250_INT_ENABLE_FF_EN                                              \
                                0x80        // Free-fall interrupt enable
#define MPU9250_INT_ENABLE_MOT_EN                                             \
                                0x40        // Motion detection interrupt
                                            // enable
#define MPU9250_INT_ENABLE_ZMOT_EN                                            \
                                0x20        // Zero motion interrupt enable
#define MPU9250_INT_ENABLE_FIFO_OFLOW_EN                                      \
                                0x10        // FIFO overflow interrupt enable
#define MPU9250_INT_ENABLE_I2C_MST_INT_EN                                     \
...
//
//*****************************************************************************
#define MPU9250_INT_STATUS_FF_INT                                             \
                                0x80        // Free-fall interrupt status
#define MPU9250_INT_STATUS_MOT_INT                                            \
                                0x40        // Motion detection interrupt
                                            // status
#define MPU9250_INT_STATUS_ZMOT_INT                                           \
                                0x20        // Zero motion interrupt status
#define MPU9250_INT_STATUS_FIFO_OFLOW_INT                                     \
                                0x10        // FIFO overflow interrupt status
#define MPU9250_INT_STATUS_I2C_MST_INT                                        \
                                0x08        // I2C master interrupt status
#define MPU9250_INT_STATUS_DATA_RDY_INT                                       \
...
//
//*****************************************************************************
#define MPU9250_ACCEL_XOUT_H_M  0xFF        // Bits [15:8] of X-axis
                                            // acceleration data
...
//
//*****************************************************************************
#define MPU9250_ACCEL_XOUT_L_M  0xFF        // Bits [7:0] of X-axis
                                            // acceleration data
...
//
//*****************************************************************************
#define MPU9250_ACCEL_YOUT_H_M  0xFF        // Bits [15:8] of Y-axis
                                            // acceleration data
...
//
//*****************************************************************************
#define MPU9250_ACCEL_YOUT_L_M  0xFF        // Bits [7:0] of Y-axis
                                            // acceleration data
...
//
//*****************************************************************************
#define MPU9250_ACCEL_ZOUT_H_M  0xFF        // Bits [15:8] of Z-axis
                                            // acceleration data
...
//
//*****************************************************************************
#define MPU9250_ACCEL_ZOUT_L_M  0xFF        // Bits [7:0] of Z-axis
                                            // acceleration data
...
//
//*****************************************************************************
#define MPU9250_ACCEL_TEMP_OUT_H_M                                            \
                                0xFF        // Bits [15:8] of temperature data
#define MPU9250_ACCEL_TEMP_OUT_H_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_ACCEL_TEMP_OUT_L_M                                            \
                                0xFF        // Bits [7:0] of temperature data
#define MPU9250_ACCEL_TEMP_OUT_L_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_00_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_00_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_01_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_01_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_02_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_02_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_03_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_03_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_04_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_04_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_05_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_05_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_06_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_06_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_07_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_07_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_08_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_08_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_09_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_09_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_10_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_10_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_11_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_11_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_12_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_12_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_13_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_13_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_14_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_14_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_15_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_15_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_16_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_16_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_17_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_17_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_18_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_18_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_19_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_19_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_20_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_20_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_21_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_21_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_22_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_22_S                                            \
                                0
...
//
//*****************************************************************************
#define MPU9250_EXT_SENS_DATA_23_M                                            \
                                0xFF        // External sensor data
#define MPU9250_EXT_SENS_DATA_23_S                                            \
                                0

//*****************************************************************************
//
// The following are defines for the bit fields in the
// MPU9250_O_MOT_DETECT_STATUS register.
//
//*****************************************************************************
#define MPU9250_MOT_DETECT_STATUS_MOT_XNEG                                    \
                                0x80        // Negative X-axis motion detect
                                            // status
#define MPU9250_MOT_DETECT_STATUS_MOT_XPOS                                    \
                                0x40        // Positive X-axis motion detect
                                            // status
#define MPU9250_MOT_DETECT_STATUS_MOT_YNEG                                    \
                                0x20        // Negative Y-axis motion detect
                                            // status
#define MPU9250_MOT_DETECT_STATUS_MOT_YPOS                                    \
                                0x10        // Positive Y-axis motion detect
                                            // status
#define MPU9250_MOT_DETECT_STATUS_MOT_ZNEG                                    \
                                0x08        // Negative Z-axis motion detect
                                            // status
#define MPU9250_MOT_DETECT_STATUS_MOT_ZPOS                                    \
                                0x04        // Positive Z-axis motion detect
                                            // status
#define MPU9250_MOT_DETECT_STATUS_MOT_ZRMOT                                   \
...
//
//*****************************************************************************
#define MPU9250_SIGNAL_PATH_RESET_GYRO                                        \
                                0x04        // Reset gyro
#define MPU9250_SIGNAL_PATH_RESET_ACCEL                                       \
                                0x02        // Reset accelerometer
#define MPU9250_SIGNAL_PATH_RESET_TEMP                                        \
...
//
//*****************************************************************************
#define MPU9250_MOT_DETECT_CTRL_ACCEL_ON_DELAY_M                              \
                                0x30        // Accelerometer wake-up delay
#define MPU9250_MOT_DETECT_CTRL_ACCEL_ON_DELAY_4MS                            \
                                0x00        // Delay 4 ms
#define MPU9250_MOT_DETECT_CTRL_ACCEL_ON_DELAY_5MS                            \
                                0x10        // Delay 5 ms
#define MPU9250_MOT_DETECT_CTRL_ACCEL_ON_DELAY_6MS                            \
                                0x20        // Delay 6 ms
#define MPU9250_MOT_DETECT_CTRL_ACCEL_ON_DELAY_7MS                            \
                                0x30        // Delay 7 ms
#define MPU9250_MOT_DETECT_CTRL_FF_COUNT_M                                    \
                                0x0C        // Free-fall counter decrement rate
#define MPU9250_MOT_DETECT_CTRL_FF_COUNT_RESET                                \
                                0x00        // Reset counter
#define MPU9250_MOT_DETECT_CTRL_FF_COUNT_1                                    \
                                0x04        // Decrement by 1
#define MPU9250_MOT_DETECT_CTRL_FF_COUNT_2                                    \
                                0x08        // Decrement by 2
#define MPU9250_MOT_DETECT_CTRL_FF_COUNT_4                                    \
                                0x0C        // Decrement by 4
#define MPU9250_MOT_DETECT_CTRL_MOT_COUNT_M                                   \
                                0x03        // Motion detect counter decrement
                                            // rate
#define MPU9250_MOT_DETECT_CTRL_MOT_COUNT_RESET                               \
                                0x00        // Reset counter
#define MPU9250_MOT_DETECT_CTRL_MOT_COUNT_1                                   \
                                0x04        // Decrement by 1
#define MPU9250_MOT_DETECT_CTRL_MOT_COUNT_2                                   \
                                0x08        // Decrement by 2
#define MPU9250_MOT_DETECT_CTRL_MOT_COUNT_4                                   \
                                0x0C        // Decrement by 4
#define MPU9250_MOT_DETECT_CTRL_ACCEL_ON_DELAY_S                              \
                                4
#define MPU9250_MOT_DETECT_CTRL_FF_COUNT_S                                    \
                                2
#define MPU9250_MOT_DETECT_CTRL_MOT_COUNT_S                                   \
                                0
...
#define MPU9250_PWR_MGMT_1_DEVICE_RESET                                       \
                                0x80        // Device reset
#define MPU9250_PWR_MGMT_1_SLEEP                                              \
                                0x40        // Enter sleep mode
#define MPU9250_PWR_MGMT_1_CYCLE                                              \
                                0x20        // Enable automatic sleep
#define MPU9250_PWR_MGMT_1_TEMP_DIS                                           \
                                0x08        // Disable temperature sensor
#define MPU9250_PWR_MGMT_1_CLKSEL_M                                           \
                                0x07        // Clock source select
#define MPU9250_PWR_MGMT_1_CLKSEL_INT                                         \
                                0x00        // Internal 8 MHz oscillator
#define MPU9250_PWR_MGMT_1_CLKSEL_XG                                          \
                                0x01        // PLL with X-axis gyro reference
#define MPU9250_PWR_MGMT_1_CLKSEL_YG                                          \
                                0x02        // PLL with Y-axis gyro reference
#define MPU9250_PWR_MGMT_1_CLKSEL_ZG                                          \
                                0x03        // PLL with Z-axis gyro reference
#define MPU9250_PWR_MGMT_1_CLKSEL_EXT32K                                      \
                                0x04        // PLL with external 32.768 kHz
                                            // reference
#define MPU9250_PWR_MGMT_1_CLKSEL_EXT19M                                      \
                                0x05        // PLL with external 19.2 MHz
                                            // reference
#define MPU9250_PWR_MGMT_1_CLKSEL_STOP                                        \
                                0x07        // Clock disable
#define MPU9250_PWR_MGMT_1_CLKSEL_S                                           \
                                0
...
//
//*****************************************************************************
#define MPU9250_PWR_MGMT_2_LP_WAKE_CTRL_M                                     \
                                0xC0        // Wake-up frequency
#define MPU9250_PWR_MGMT_2_LP_WAKE_CTRL_1_25                                  \
                                0x00        // Wake-up at 1.25 Hz
#define MPU9250_PWR_MGMT_2_LP_WAKE_CTRL_5                                     \
                                0x40        // Wake-up at 5 Hz
#define MPU9250_PWR_MGMT_2_LP_WAKE_CTRL_20                                    \
                                0x80        // Wake-up at 20 Hz
#define MPU9250_PWR_MGMT_2_LP_WAKE_CTRL_40                                    \
                                0xC0        // Wake-up at 40 Hz
#define MPU9250_PWR_MGMT_2_STBY_XA                                            \
                                0x20        // Put X-axis accelerometer into
                                            // standby mode
#define MPU9250_PWR_MGMT_2_STBY_YA                                            \
                                0x10        // Put Y-axis accelerometer into
                                            // standby mode
#define MPU9250_PWR_MGMT_2_STBY_ZA                                            \
                                0x08        // Put Z-axis accelerometer into
                                            // standby mode
#define MPU9250_PWR_MGMT_2_STBY_XG                                            \
                                0x04        // Put X-axis gyro into standby
                                            // mode
#define MPU9250_PWR_MGMT_2_STBY_YG                                            \
                                0x02        // Put Y-axis gyro into standby
                                            // mode
#define MPU9250_PWR_MGMT_2_STBY_ZG                                            \
                                0x01        // Put Z-axis gyro into standby
                                            // mode
#define MPU9250_PWR_MGMT_2_LP_WAKE_CTRL_S                                     \
                                6
...
#define MPU9250_WHO_AM_I_MPU9250                                              \
                                0x68        // MPU9250
#define MPU9250_WHO_AM_I_S      1

#endif /* DRIVERS_HW_MPU9250_H_ */
